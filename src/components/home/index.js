...
class Home extends Component {
  ...
  componentDidMount() {
    fetch(
      "https://cdn.contentful.com/spaces/lfibhjwf8l76/entries?access_token=ac626e994db36e47fed21fc5d5b5c2019df79ac53a77d06ee13b3163ef7af3a0&content_type=organization&order=fields.timestamp"
    )
            ...
            <div>
              ...
              <div className="cta__container">
                <a
                  href="/schedule"
                  target="_blank"
                  className="cta-button button__light"
                >
                  Past Events
                </a>
              </div>
            ...
            <div>
              ...
              <div className="cta__container">
                {perf.map ? (
                  ...
                  <a href="/schedule" className="cta-button button__light">
                    See Schedule
                  </a>
                )}
              </div>
    ...
    return (
      <div className="gridBox gridBox__messiah">
        <div className="gridBox-overlay">
          ...
          <blockquote className="blockquote__recent">
            Elegantly <br />
            commanding
          </blockquote>
          <div className="cta__container">
            <a href="/about" className="cta-button button__light">
              See More
            </a>
          </div>
        </div>
  ...
  render() {
    return (
      <div className="">
        ...
        <PlayButton
          className="button black btn-big button-outline button-grow bg-white circle"
          {...this.props}
        />
      </div>
    );
